...
const stepsData: StepData[] = [
  ...
  {
    img: "/img/section4/step2.png",
    icon: <ChevronFirst size={30} />,
    step: "2",
    title: "편지가 열릴 순간을 정해요",
    contents:
      "이 편지를 '언제' 또는 '어디에서' 열고 싶나요?\n기념일, 여행지, 추억의 장소처럼 특별한 조건을 설정하면 편지는 잠긴 채로, 당신이 정한 순간을 조용히 기다립니다.",
  },
  {
    img: "/img/section4/step3.png",
    icon: <ChevronFirst size={30} />,
    step: "3",
    title: "도착하지만 아직 열리지 않는 편지예요",
    contents:
      "링크를 보내는 순간, 편지는 목적지로 향하지만 잠금은 그대로. \n받는 사람은 이미 알고 있으면서도, 아직은 열 수 없다는 사실에 작은 설렘과 궁금함을 함께 느끼게 됩니다.",
  },
  {
    img: "/img/section4/step4.png",
    icon: <ChevronFirst size={30} />,
    step: "4",
            ...
            {stepsData.map((item, index) => (
              ...
              >
                <div className="block md:hidden">
                  <p className="font-medium md:font-semibold text-[#ff2600]-3 md:text-[#ff2600] text-2xl md:text-3xl">
                    {STEP_LABELS[index]}
                  </p>
